...
import { book, bookingConfirmation, cancel, create } from '../../services/orders';
...
// router.post('/:id([0-9]+)/cancellations/:cid/confirmation', [validatorCancellationConfirmation], cancellationConfirmation);
